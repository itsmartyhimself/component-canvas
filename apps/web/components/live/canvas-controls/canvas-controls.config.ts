...
export const VARIANT_GAP = 6
export const CHIP_HEIGHT = 24
export const CHIP_RADIUS = 8
export const CHIP_PAD_X = 8
export const CHIP_MAX_WIDTH = 64
export const VARIANT_INLINE_MAX = 4
...
export const SIZE_GAP = 4
export const SIZE_CHIP_W = 26
...
export const PANEL_DIVIDER_COLOR = "var(--color-border-secondary)"
